...
<?php include_once 'template/header.php';?>
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/toys.jpg');">
      ...
      <div class="container">
        ...
        <div class="row block-12">
            <div class="col-md-4 order-md-last d-flex"></div>
          <div class="col-md-4 order-md-last d-flex">
          <h4><img src="img/icon/warning.png" style="height:30px;width:auto;margin:10px;padding:2px;"><b><?php echo $msg2;?></b></h4>
          </div>
          <div class="col-md-4 order-md-last d-flex"></div>
          </div>
            </section>
    ...
    <form action="actionAddProducts.php" method="POST" class="bg-white p-5 contact-form" enctype="multipart/form-data">
             <h3 class="billing-title text-center">Add Products</h3>
              ...
              <div class="form-group">
                <textarea name="details" id="" cols="30" rows="3" class="form-control" placeholder="Product Description"></textarea>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    <button type="submit" value="Send Message" class="btn btn-primary py-3 px-4" style="margin-left: 30%">Add Product</button>
              </div>
