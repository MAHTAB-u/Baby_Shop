      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <h1 class="mb-0 bread">Edit Products</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section ftco-cart">
		...
		?>
		  <tr>
			...
			<td>
				<a class="btn btn-danger py-3 px-4" href="UpdateProduct.php?proId=<?=$row['productId']?>"> <span>Update</span></a>
				<a class="btn btn-success py-3 px-4" href="actionDeleteProduct.php?proId=<?=$row['productId']?>"><span>Delete </span></a>
			</td>
		  </tr>
